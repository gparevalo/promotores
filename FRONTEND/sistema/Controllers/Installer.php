...
class Installer extends Controllers
{
	...
	public function index()
	{
		...
		$idInstaller = $_SESSION['usuario']['idStaff'];
		$data['prospects'] = $this->model->getProspects($idInstaller);
		$data['page_functions_js'] = "installer.js";
