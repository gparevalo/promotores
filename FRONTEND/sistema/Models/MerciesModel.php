...
class MerciesModel extends Mysql
{
    ...
    public function getMercies()
    {
        $sql = "SELECT 
                ...
                WHERE prospects.estado = 'prospectos' AND prospects.installedProspect = 'Finalizado' ORDER BY prospects.idProspect DESC";
    ...
    function addProspect()
    {
        ...
        $nameProspect = !empty($_POST['nameProspect']) ? $_POST['nameProspect'] : "----------";
        $lastNameProspect = !empty($_POST['lastNameProspect']) ? $_POST['lastNameProspect'] : "----------";
        $rucCIProspect = !empty($_POST['rucCIProspect']) ? $_POST['rucCIProspect'] : "----------";
        $phoneProspect = !empty($_POST['phoneProspect']) ? $_POST['phoneProspect'] : "----------";
        $emailProspect = !empty($_POST['emailProspect']) ? $_POST['emailProspect'] : "----------";        
    ...
    function sendRejectedProspect()
    {
        ...
        $sql_update = "UPDATE prospects SET notaProspect = ? WHERE idProspect = ?";
        $arrData_update = array(
            $notaProspect,
            $idProspect
        );
