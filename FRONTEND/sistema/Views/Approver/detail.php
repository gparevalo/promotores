...
<body>
    ...
    <section class="wrap-general-detalle">
        <section class="navdesk">
            ...
            <a href="<?= base_url() ?>/Aprobador" class="bt-navdeskt"><span class="icon-award ico-djf8393"></span>Prospectos</a>
        ...
        <section class="resultados resultados-int">
            <section class="wrap-linkback">
                <a href="<?= base_url() ?>/Aprobador" class="subtitle-category"><span class="icon-arrow-left-circle ico-hd627s77"></span>Prospectos </a>
    ...
    <div class="awesome-nav" id="proceso">
        ...
        <div class="wrap-nav-int">
            ...
            <select name="" id="" class="campo-registro">
                <option value="">Prospecto visitado</option>
                <option value="">No iniciado</option>
                <option value="">En proceso</option>
                <option value="">Finalizado</option>
            </select>

            <input type="text" class="campo-registro mrdwn" placeholder="Adjuntar imagen">


            <select name="" id="" class="campo-registro">
                <option value="">Apertura de cuenta</option>
                <option value="">No iniciado</option>
                <option value="">En proceso</option>
                <option value="">Finalizado</option>
            </select>
            ...
            <select name="" id="" class="campo-registro">
                <option value="">Afiliación y capacitación</option>
                <option value="">No iniciado</option>
                <option value="">En proceso</option>
                <option value="">Finalizado</option>
            </select>
