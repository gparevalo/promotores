...
<body>
                    ...
                    <section class="item-contact">
                        <section class="itemcontact-left">
                            ...
                            <section class="wrap-item-contact">
                                ...
                                <?php } else { ?>
                                    <p class="item-int-data check">
                                        <span class="icon-trending-up ico-d62"></span>Estado: No iniciado
                                    </p>
                                <?php } ?>
                            </section>
                        </section>
                        ...
                        <section class="itemcontact-right1">
                            ...
                            <a href="<?= base_url() ?>/Promotor/detalle/<?= $titulo ?>-<?= $row->idProspect ?>" class="icon-info ico-dj7f8s7s"></a>
    ...
    <div class="awesome-nav" id="estados">
        ...
        <div class="wrap-nav-int">
            ...
            <p class="item-estados-pop"><span class="icon-check ico-836dh"></span> No iniciado</p>
    ...
    <?php foreach ($data->prospects as $row) { ?>
        <div class="awesome-nav" id="view-info-<?= $row->idProspect ?>">
            ...
            <div class="wrap-nav-int">
                ...
                <?php $titulo = create_slug($row->category . " " . $row->nameCProspect) ?>
                <a href="<?= base_url() ?>/Promotor/detalle/<?= $titulo ?>-<?= $row->idProspect ?>" class="bt-next1">Editar <span class="icon-edit-3 ico-djde837"></span></a>
            </div>
        </div>
    <?php } ?>
