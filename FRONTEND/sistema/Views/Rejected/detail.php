...
<head>
    ...
    <title>Detalle Prospecto Rechazado | Cofeps</title>

    <meta property="og:type" content="website">
    <meta property="og:url" content="https://dominio.com/">
    <meta property="og:site_name" content="https://dominio.com/">
    <meta property="og:title" content="Detalle Prospecto Rechazado | Cofeps">
    ...
    <section class="wrap-general-detalle">
        ...
        <section class="resultados resultados-int">
            <section class="wrap-linkback">
                <a href="<?= base_url() ?>/Rechazados" class="subtitle-category"><span class="icon-arrow-left-circle ico-hd627s77"></span>Rechazados </a>
            ...
            <section class="details-prospect">
                <section class="detail-prospect-left">
                    ...
                    <section class="dataperson">
                        ...
                        <p class="item-dataperson"><span class="icon-user ico-jdj2827"></span><?= empty($prospect->nameProspect) ? '----------' : $prospect->nameProspect ?> <?= empty($prospect->lastNameProspect) ? '----------' : $prospect->lastNameProspect ?></p>
                        <p class="item-dataperson"><span class="icon-phone-call ico-jdj2827"></span><?= empty($prospect->phoneProspect) ? '----------' : $prospect->phoneProspect ?></p>
                        <p class="item-dataperson"><span class="icon-mail ico-jdj2827"></span><?= empty($prospect->emailProspect) ? '----------' : $prospect->emailProspect ?></p>
                        <p class="item-dataperson"><span class="icon-briefcase ico-jdj2827"></span>RUC: <?= empty($prospect->rucCIProspect) ? '----------' : $prospect->rucCIProspect ?></p>
