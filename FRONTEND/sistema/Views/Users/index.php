...
<body>
    ...
    <section class="wrap-general">
        ...
        <section class="resultados">
            <p class="title-category"><span class="icon-users ico-d399f88"></span>Usuarios <!-- <span class="nros"> | 3 898 registros</span> --></p>
            ...
            <section class="wrap-viewpl <?= count($data->users) > 20 ? '' : 'ocult'; ?>">
                <button id="show-more-btn" class="bt-next1">Ver 20 más<span class="icon-eye ico-djde837"></span></button>
                <span class="restante"><?= count($data->users); ?> por ver</span>
            </section>
        </section>
    ...
    <?php foreach ($data->users as $row) { ?>
        <div class="awesome-nav" id="view-info-<?= $row->idStaff ?>">
            ...
            <div class="wrap-nav-int">
                <p class="title-pop2">Datos de <span>supervisor</span></p>
                ...
                <section class="wrap-btnsaction">
                    ...
                    <a href="<?= base_url() ?>/Usuarios/sendEmail/<?= $row->emailStaff ?>-<?= $row->claveStaff ?>" class="bt1b"><span class="icon-mail ico-djde837"></span></a>
                </section>
            </div>
        </div>
    <?php } ?>
        ...
        <div class="awesome-nav" id="view-edit-<?= $row->idStaff ?>">
            ...
            <div class="wrap-nav-int">
                <form id="frmStaff<?= $row->idStaff ?>" method="POST">
                    <p class="title-pop2">Editar <span>supervisor</span></p>
                    ...
                    <a href="javascript: void(0)" onclick="editUser(<?= $row->idStaff ?>)" class="bt-next1">Guardar <span class="icon-check-circle ico-djde837"></span></a>
                </form>
            </div>
        </div>
    <?php } ?>
    ...
    <div class="awesome-nav" id="view-create">
        <a href="#cerrar" class="icon-x-circle ico-clspop"></a>
        <div class="wrap-nav-int">
            <p class="title-pop2">Crear supervisor</p>
            <form id="frmUser" method="POST">
                ...
                <a href="javascript:void(0)" class="bt-next1" onclick="btnAgregarUser()">Crear <span class="icon-check-circle ico-djde837"></span></a>
            </form>
        </div>
    </div>
    ...
    <?php foreach ($data->users as $row) { ?>
        <div class="awesome-nav" id="eliminar-<?= $row->idStaff ?>">
            ...
            <div class="wrap-nav-int">
                ...
                <section class="wrap-btnsaction">
                    <a href="javascript: void(0)" onclick="deleteUser(<?= $row->idStaff ?>)" class="bt1a">Si, Eliminar <span class="icon-check ico-djde837"></span></a>
